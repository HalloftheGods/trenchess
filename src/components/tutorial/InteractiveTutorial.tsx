...
import { deserializeGame } from "../../utils/shared/gameUrl";
import TerrainMovePreview from "../game/TerrainMovePreview"; // Updated import
import TerrainDetailsPanel from "../game/TerrainDetailsPanel"; // New component
