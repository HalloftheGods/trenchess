  ...
  return (
    <button
      ...
      className={`
        ...
        ${
          active
            ? "border-white/40 bg-white/15 shadow-[0_0_12px_rgba(255,255,255,0.15)] scale-110 z-10"
    ...
    >
      ...
      {badge !== undefined && (
        <span className="absolute -top-1.5 -right-1.5 min-w-[18px] h-[18px] bg-slate-900/90 rounded-full text-[9px] flex items-center justify-center font-black border border-white/20 text-white shadow-sm backdrop-blur-sm px-1">
          {badge}
        </span>
      )}
      {label && (
