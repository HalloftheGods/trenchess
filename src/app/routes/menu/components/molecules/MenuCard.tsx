  ...
  return (
    <button
      ...
      className={`card-base group ${
        isDisabled ? "card-disabled" : "card-hover"
    ...
    >
      ...
      <div className="inset-x-0 top-0 h-px bg-white/20 dark:bg-white/10 z-20 group-hover:bg-white/40 transition-colors" />
      <div className="inset-0 bg-gradient-to-br from-white/10 to-transparent pointer-events-none z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
      ...
      <div className="relative w-20 h-20 flex items-center justify-center">
        ...
        {hoverText && (
          <div
            className={`transition-all duration-700 absolute flex items-center justify-center z-10 text-7xl opacity-0 scale-50 font-serif group-hover:opacity-100 group-hover:scale-110 ${styles.iconColor} drop-shadow-[0_0_25px_currentColor]`}
          >
            {hoverText}
          </div>
        )}
