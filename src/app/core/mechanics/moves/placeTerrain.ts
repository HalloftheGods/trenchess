...
import { applyTerrainPlacement } from "@/app/core/setup/placement";
...
export const placeTerrain = (
  ...
  const result = applyTerrainPlacement(
    gameState,
    playerId,
    row,
    col,
  ...
  // applyTerrainPlacement returns a new state object, but boardgame.io expects mutations to G
  gameState.terrain = result.terrain;
  gameState.terrainInventory = result.terrainInventory;
};
