...
const DebugRoomView: React.FC = () => {
  ...
  useEffect(() => {
    // Only initialize if we are in the MENU phase (initial state)
    const isInitialState = !multiplayer.roomId && gameState === PHASES.MENU;
  ...
  }, [gameState, multiplayer.roomId, initGameWithPreset, setPhase, authorizeMasterProtocol, ready, activePlayers, setTurn]);
