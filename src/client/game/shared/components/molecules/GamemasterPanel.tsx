  ...
  return (
    <div className="relative w-80 flex flex-col gap-4">
      <div className="bg-white/95 dark:bg-slate-900/90 backdrop-blur-xl rounded-[2.5rem] p-6 pt-10 border-2 border-slate-200 dark:border-white/10 shadow-2xl relative">
        {/* Corner Ribbon */}
        <div
          className={`ribbon-right ${ribbonBgClass} text-[14px] font-black uppercase tracking-[0.1em] text-white shadow-xl`}
        >
          PLAYER {playerID}
        </div>
        ...
        <div className="flex items-center gap-2 mb-6">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              <h3
                className={`text-lg font-black uppercase tracking-widest ${accentTextClass}`}
              >
                PLAYER {playerID}
              </h3>
            </div>
