...
const QUADRANT_COLORS: Record<string, StyleConfig> = {
  red: {
    inner: [
      "bg-red-400/60 dark:bg-red-900/42",
      "bg-red-500/60 dark:bg-red-950/42",
    ],
    outer: [
      "bg-red-200/60 dark:bg-red-900/57",
      "bg-red-300/60 dark:bg-red-950/57",
    ],
  },
  blue: {
    inner: [
      "bg-blue-400/60 dark:bg-blue-900/42",
      "bg-blue-500/60 dark:bg-blue-800/42",
    ],
    outer: [
      "bg-blue-200/60 dark:bg-blue-900/57",
      "bg-blue-300/60 dark:bg-blue-800/57",
    ],
  },
  yellow: {
    inner: [
      "bg-yellow-400/60 dark:bg-yellow-900/42",
      "bg-yellow-500/60 dark:bg-yellow-950/42",
    ],
    outer: [
      "bg-yellow-200/60 dark:bg-yellow-900/57",
      "bg-yellow-300/60 dark:bg-yellow-950/57",
    ],
  },
  green: {
    inner: [
      "bg-emerald-400/60 dark:bg-emerald-900/42",
      "bg-emerald-500/60 dark:bg-emerald-950/42",
    ],
    outer: [
      "bg-emerald-200/60 dark:bg-emerald-900/57",
      "bg-emerald-300/60 dark:bg-emerald-950/57",
    ],
  },
  slate: {
